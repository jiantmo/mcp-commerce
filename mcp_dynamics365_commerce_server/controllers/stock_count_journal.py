...
class StockCountJournalController:
    def get_tools(self) -> List[Tool]:
        return [
            ...
            Tool(name="stock_count_journal_remove_stock_count_line_by_line_id", description="Deletes the stock count line by line identifier.", inputSchema={"type":"object","properties":{"journalId":{"type":"string"},"stockCountLineId":{"type":"number"},"baseUrl":{"type":"string","default":"https://your-commerce-site.com"}},"required":["journalId","stockCountLineId"]}),
            Tool(name="stock_count_journal_remove_stock_count_line_by_product_rec_id", description="Deletes the stock count line by product identifier.", inputSchema={"type":"object","properties":{"journalId":{"type":"string"},"productRecId":{"type":"number"},"baseUrl":{"type":"string","default":"https://your-commerce-site.com"}},"required":["journalId","productRecId"]}),
