...
class ScanResultController:
    def get_tools(self) -> List[Tool]:
        return [
            Tool(name="scan_result_get_entity_by_key", description="Gets the ScanResult entity by key.", inputSchema={"type":"object","properties":{"scannedText":{"type":"string"},"baseUrl":{"type":"string","default":"https://sculxdon4av67499847-rs.su.retail.test.dynamics.com"}},"required":["scannedText"]})
        ]
