...
class ExtensibleEnumerationController:
    def get_tools(self) -> List[Tool]:
        return [
            Tool(name="extensible_enum_get_enumerations", description="Gets extensible enumerations.", inputSchema={"type":"object","properties":{"baseUrl":{"type":"string","default":"https://your-commerce-site.com"}},"required":[]})
        ]
