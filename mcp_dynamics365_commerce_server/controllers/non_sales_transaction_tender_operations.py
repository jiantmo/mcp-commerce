...
class NonSalesTransactionTenderOperationsController:
    def get_tools(self) -> List[Tool]:
        return [
            ...
            Tool(name="non_sales_tender_create_transaction", description="Creates non-sales transaction.", inputSchema={"type":"object","properties":{"nonSalesTransaction":{"type":"object"},"baseUrl":{"type":"string","default":"https://your-commerce-site.com"}},"required":["nonSalesTransaction"]}),
            Tool(name="non_sales_tender_get_affiliations", description="Gets affiliations.", inputSchema={"type":"object","properties":{"queryResultSettings":{"type":"object"},"baseUrl":{"type":"string","default":"https://your-commerce-site.com"}},"required":[]})
        ]
